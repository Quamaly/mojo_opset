...
rmsnorm_tle_infer_impl = _get_kernel_impl(ttx_backend_module, "rmsnorm_tle_infer_impl")
layernorm_infer_impl = _get_kernel_impl(ttx_backend_module, "layernorm_infer_impl")
layernorm_tle_infer_impl = _get_kernel_impl(ttx_backend_module, "layernorm_tle_infer_impl")
...
fused_add_rmsnorm_tle_infer_impl = _get_kernel_impl(ttx_backend_module, "fused_add_rmsnorm_tle_infer_impl")
